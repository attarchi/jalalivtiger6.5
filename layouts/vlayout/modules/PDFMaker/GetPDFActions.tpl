 ...
 ********************************************************************************/
*}
{if $ENABLE_EMAILMAKER neq 'false'}
...
<script type="text/javascript" src="resources/PDFMakerActions.js"></script>
<div class="row-fluid">
	<div class="span10">
        ...
        <li>
            <a style="padding-left:10px;" class="webMnu" onclick="PDFMaker_Actions_Js.sendEmailWithPDF('{$MODULE}','{$ID}','','','');" href="javascript:;"><img hspace="5" align="absmiddle" border="0" style="border-radius:3px;" src="layouts/vlayout/modules/PDFMaker/images/PDFMail.gif"> {vtranslate('LBL_SENDEMAIL','PDFMaker')}</a>
                </li>
